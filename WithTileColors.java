...
public class WithTileColors extends JFrame implements KeyListener{
    ...
    public void Game(){
        ...
        for(int i=0;i<16;i++){
            ...
            box[i].setVerticalAlignment(SwingConstants.CENTER);
            box[i].setPreferredSize(new Dimension(50, 40));
            box[i].setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
            box[i].setFont(box[i].getFont().deriveFont(20f));
